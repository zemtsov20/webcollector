...
//
//    @Autowired
//    private RawDataRepository categoryDataRepo;
//
//    @Transactional
...
//    }
//
//    private List<RawData> getJsonContent(String json) {
...
//            if (jsonArray.size() == 0) {
//                RawData rawData = gson.fromJson(jsonObj, RawData.class);
//                rawData.setState(State.QUEUED);
//                rawData.setPageUrl(rawData.getPageUrl().concat("?page=1"));
